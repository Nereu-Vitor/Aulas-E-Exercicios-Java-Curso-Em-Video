...
public class TelaFatorial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblFormaFat = new javax.swing.JLabel();
        ...
        lblFormaFat.setFont(new java.awt.Font("Segoe UI", 0, 30)); // NOI18N
        lblFormaFat.setText("0! = 1");
    ...
    private void txtNumStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_txtNumStateChanged
        ...
        // Modificado para aparecer como cegou no fatorial do número
        int num = Integer.parseInt(txtNum.getValue().toString());
        int fat = 1;
        int c = num;
        String formaFatorial = String.format("%d! = ", num);
        ...
        lblFormaFat.setText(formaFatorial);
    ...
    private javax.swing.JLabel lblFormaFat;
